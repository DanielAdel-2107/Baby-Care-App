...
import 'package:baby_care/core/network/supabase/auth/sign_up_with_password.dart';
...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  List<String> userRoles = ["Parent", "Baby Sitter"];
      ...
      try {
        ...
        await addData(
          ...
          data: {
            ...
            if (roleController.text == "Baby Sitter") "complete_profile": false
          },
        );
        emit(SignUpSuccess());
